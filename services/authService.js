...
exports.createUser = async (email, password) => {
    ...
    let mailOptions = {
        ...
        html: `
                ...
                <p>Bạn vui lòng thực hiện xác minh: <a href="${verificationLink}" target="_blank">Xác minh tài khoản</a>.</p>
                <br>
                <p>Sau khi xác minh, bạn sẽ được điều hướng đến trang đăng nhập của hệ thống. Hãy đăng nhập tài khoản của mình với vai trò là <strong>Khách</strong>.</p>
                <br>
                <p>Trân trọng,</p>
