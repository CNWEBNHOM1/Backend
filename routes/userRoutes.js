...
// VNPAY route 
router.post('/getRoomPaymentUrl', auth(['Sinh viên']), userController.getRoomPaymentUrl);
router.get('/getRoomPaymentReturn', auth(['Sinh viên']), userController.getRoomPaymentReturn);
